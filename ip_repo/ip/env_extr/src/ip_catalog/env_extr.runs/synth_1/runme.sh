...
HD_PWD='C:/Users/windows/Desktop/HSS/Q16_40840_optim/code2/ip/env_extr/src/ip_catalog/env_extr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log env_extr_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source env_extr_bd_wrapper.tcl
