...
sample_period_filtering = 1/100e6;
...
grp_delay_swt = 12;
sample_period_swt = 1/100e6;
%% Hilbert
fft_len_hilb = 2048; %FR ~ 1 Hz
fft_freq = 32;

sample_period_hilbert = 1/100e6;
grp_delay_hilb = 11;

%% Homomorphic
% log
log_word_len_homo = 24;
log_fract_len_homo = 23;
...
cordic_input_width = 24;
cordic_bin_point = 21;
cordic_output_width = 16;
cordic_delay = 20;
cordic_iterations = 18;

grp_delay_homo = 13;

sample_period_homo = 1/100e6;
%% PSD
fft_length = 4096;
window_dim = 100;
